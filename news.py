#網頁爬蟲，Chrome 檢查畫面(F12)
#安裝chrome的外掛jsonview
#需要字典欄位
#data[newsId]、data[title]、data[content]、data[summary]
#鉅亨網
#https://api.cnyes.com/media/api/v1/newslist/category/headline?page=1&limit=30&startAt=1752645542&endAt=1753509542
#拆解為
#連結 https://api.cnyes.com/media/api/v1/newslist/category/headline
#參數 page=1&limit=30&startAt=1752645542&endAt=1753509542
#變成 "page":1,"limit":30,"startAt":1752645542,"endAt":1753509542
